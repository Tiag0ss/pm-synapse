...
/**
 * Build YAML `estimate:` list (categories + trailing Total):
 *   estimate:
 *     - Task: Design
 *       hours: 5
 *       indent: 1
...
/**
 * Recalculate `estimate:` from checkbox + frontmatter todo hours/category,
 * ending with `Task: Total` (indent 0). Missing category → Other.
 */
